...
module.exports=(app)=>{
    ...
    app.post("/submitBooking",async(req,res)=>{
        ...
        if(availableTime.period.includes(chosenTime)){
            ...
            //     secure: true,
            //     auth: {
            //       user: "jzyoung0122@zohomail.com.au",
            //       pass: "448918uck&",
            //     },
            //     customAuth: {
            //         user: 'jzyoung0122@zohomail.com.au',
            //         XOAUTH2: 'TPABt9fJ1yPW',
            //         XMailer: 'nodemailer', // Set your App Name here
            //       },
            //   });

            //   let info = await transporter.sendMail({
            //     from: "Booking notification --  <jzyoung0122@zohomail.com.au>",
            //     to: 'jzyoung0122@gmail.com',
            ...
            //         <p>Hi,Dear Peter</p>
            //         <p>You have a new booking on ${chosenTime}.Please check it in time</p>
